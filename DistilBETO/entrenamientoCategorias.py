"""
entrenamiento-categorias-distilbeto.py
----------------------------------------
...
Misma arquitectura multi-etiqueta que RoBERTuito y BETO pero con
DistilBETO como modelo base. Hiperparámetros idénticos para comparación justa.
"""
...
OUTPUT_DIR = "./resultados_distilbeto_categorias"
SAVE_PATH  = "./modelo_distilbeto_categorias_final"
MAX_LENGTH = 128
SEED       = 42
...
def main():
    ...
    # --- Entrenamiento ---
    print(f"\nIniciando entrenamiento (Fine-Tuning DistilBETO — Categorías)...")
    trainer.train()
