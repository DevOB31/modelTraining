"""
entrenamiento-nivelDeRiesgo-beto.py
-------------------------------------
...
Diferencias clave vs RoBERTuito:
  - BETO es "cased": distingue mayúsculas/minúsculas y tildes.
  - Pre-entrenado con texto formal en español (corpus Wikipedia y otros).
  - Arquitectura BERT-base con Whole Word Masking (WWM).
  - Mismos hiperparámetros que RoBERTuito para comparación justa.
"""
...
# ==========================================
# Usamos la versión "cased" porque el español es sensible a
# mayúsculas, tildes y la letra ñ.
MODEL_NAME = "dccuchile/bert-base-spanish-wwm-cased"
DATA_PATH  = "../data/dataset_tesis_limpio.csv"
OUTPUT_DIR = "./resultados_beto_riesgo"
SAVE_PATH  = "./modelo_beto_riesgo_final"
MAX_LENGTH = 128
...
def main():
    ...
    # --- Entrenamiento ---
    print(f"\nIniciando entrenamiento (Fine-Tuning BETO — Nivel de Riesgo)...")
    trainer.train()
