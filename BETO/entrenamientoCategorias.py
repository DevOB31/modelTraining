"""
entrenamiento-categorias-beto.py
----------------------------------
...
Misma arquitectura que RoBERTuito multi-etiqueta pero con BETO como
modelo base. Hiperparámetros idénticos para comparación justa.
"""
...
OUTPUT_DIR = "./resultados_beto_categorias"
SAVE_PATH  = "./modelo_beto_categorias_final"
MAX_LENGTH = 128
SEED       = 42
...
def main():
    ...
    # --- Entrenamiento ---
    print(f"\nIniciando entrenamiento (Fine-Tuning BETO — Categorías)...")
    trainer.train()
