...
# CONFIGURACIÓN
# ==========================================
RIESGO_MODEL_PATH     = "./modelo_beto_riesgo_final"
CATEGORIAS_MODEL_PATH = "./modelo_beto_categorias_final"
MAX_LENGTH            = 128
...
def cargar_modelos():
    ...
    print("Cargando modelo de categorías...")
...
def predecir_categorias(texto, tokenizer, model, device, umbral=UMBRAL_CATEGORIAS):
    ...
    # Si ninguna supera el umbral, tomar la de mayor probabilidad
    if not detectadas:
...
def main():
    print("=" * 65)
    print("   Predictor BETO — Riesgo + Categorías Pedagógicas")
    print("=" * 65)
